 ...
 *
 *  This version uses OpenCV libraries to create a viewer as well as capture.
 *
...
char disp_window_name[] = "Video Capture Display";
...
static void process_image(const void *p, int size)
{
    ...
    Mat dispimg(VRES, HRES, CV_8UC3, bigbuffer);
...
int main(int argc, char **argv)
{
    ...
    namedWindow(disp_window_name, CV_WINDOW_AUTOSIZE);
